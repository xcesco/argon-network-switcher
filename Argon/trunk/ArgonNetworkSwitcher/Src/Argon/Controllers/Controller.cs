...
namespace Argon.Controllers
{
    public class Controller
    {
        ...
        public void ActivateFormProfile(FormProfile currentFormProfile)
        {
            ...
            _view.ToolStripButtonManager.EnableButtons(main.btnProfileRun, main.btnProfileRefresh, main.btnProfileSave);            
        ...
        public void ActivateFormProfiles()
        {
            ...
            _view.ToolStripButtonManager.EnableButtons(main.btnProfilesLoad, main.btnProfilesSave);                       
